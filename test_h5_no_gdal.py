...
def main():
    ...
    parser.add_argument(
        "--ckpt",
        type=str,
        default="/mnt/hdd/data/PBVS_HISR/checkpoints/best.pth",
        help="checkpoint path",
    )
    parser.add_argument(
        "--test_dir",
        type=str,
        default="/mnt/hdd/data/PBVS_HISR/final_test",
    ...
    result_root = "./result"
    default_save_dir = os.path.join(result_root, ckpt_name)
    default_submit_dir = os.path.join(result_root, f"submit_{ckpt_name}")
